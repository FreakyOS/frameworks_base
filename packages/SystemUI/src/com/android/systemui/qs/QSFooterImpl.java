...
public class QSFooterImpl extends FrameLayout implements QSFooter,
        OnClickListener, OnLongClickListener, OnUserInfoChangedListener, BrightnessMirrorListener {
    ...
    public boolean onLongClick(View v) {
        if (v == mSettingsButton) {
            startFreakyGraveyardActivity();
            vibrateheader();
        }
        return false;
    }

    private void startFreakyGraveyardActivity() {
        Intent nIntent = new Intent(Intent.ACTION_MAIN);
        nIntent.setClassName("com.android.settings",
            "com.android.settings.Settings$FreakyGraveyardActivity");
