...
public class StatusBar extends SystemUI implements DemoMode,
   ...
   private void setHapticFeedbackForBackGesture() {
    ...
    public void updateSwitchStyle() {
        ...
        FreakyUtils.updateSwitchStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), switchStyle);
    }

    public void stockSwitchStyle() {
        FreakyUtils.stockSwitchStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId());
    }
